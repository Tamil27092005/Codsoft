...
(function() {
    ...
    var data = {
        "resource": {
            ...
            "rules": [[["if", 0], ["add", 0, 0, 1]], [["if", 1], ["add", 0]], [["if", 2], ["add", 0]]]
        },
        "runtime": [[50, "__cl", [46, "a"], [52, "b", ["require", "internal.enableAutoEventOnClick"]], ["b"], [2, [15, "a"], "gtmOnSuccess", [7]]], [50, "__e", [46, "a"], [36, [13, [41, "$0"], [3, "$0", ["require", "internal.getEventData"]], ["$0", "event"]]]]
        ],
        "entities": {
            "__e": {
                "2": true,
...
*/
    ...
    var Bc = function(a, b, c, d, e) {
      ...
      , Jc = function(a) {
        var b = H.createElement("div"), c = b, d, e = qc("A<div>" + a + "</div>"), f = Rb(), g = f ? f.createHTML(e) : e;
        d = new nc(g,mc);
        if (c.nodeType === 1) {
            var k = c.tagName;
            if (k === "SCRIPT" || k === "STYLE")
    ...
    hi.ie = Number("0") || 0;
    hi.Ya = "dataLayer";
    hi.Zm = "ChAI8L75swYQ2s+tzbbu4P1MEiQAQ0FpTa9+BTZU++LAIpO7UEEurtL81QOuBNE/btJ3bxh4NVsaAgHJ";
    var ji = {
        __cl: 1,
        __ecl: 1,
        __ehl: 1,
    ...
    function bj(a, b, c, d, e) {
        ...
        b === "port" ? a.port = String(Number(a.hostname ? a.port : G.location.port) || (a.protocol === "http" ? 80 : a.protocol === "https" ? 443 : "")) : b === "host" && (a.hostname = (a.hostname || G.location.hostname).replace(Zi, "").toLowerCase());
        return dj(a, b, c, d, e)
    }
    ...
    var qj = G.location.search.indexOf("?gtm_latency=") >= 0 || G.location.search.indexOf("&gtm_latency=") >= 0;
    var rj = {
        sampleRate: "0.005000",
        hk: "",
        Xm: "0.005"
    ...
    function Qj() {
        ...
        if (a) {
            ...
            if (b.siloed) {
                ...
                g++)
                    f.Bf = b.siloed[g],
                    !Bj && tb(f.Bf.isDestination ? e : d, function(k) {
                        return function(m) {
                            return m === k.Bf.ctid
                        }
                    }(f)) ? Bj = !0 : c.push(f.Bf);
    ...
    function Sj() {
        for (var a = Mf.ctid, b = Cj(), c = Fj(), d = function(n, p) {
            var q = {
        ...
        }, e = yj(), f = na(b), g = f.next(); !g.done; g = f.next())
            d(g.value, !1);
    ...
    function kk(a, b, c, d) {
        ...
        if (e === void 0)
            if (a)
                ...
                return "";
        for (var f = [oj("https://www.googletagmanager.com"), a ? "/td" : "/a", ek], g = na(a ? bk : ak), k = g.next(); !k.done; k = g.next())
    ...
    function yk(a, b) {
        if (vk[a] === void 0 || (b === void 0 ? 0 : b))
            vk[a] = !0
    }
    function zk(a) {
        a = a === void 0 ? !1 : a;
        var b = Object.keys(vk).filter(function(c) {
    ...
    function Fk() {
        ...
        Fc(G, "pagehide", Ck),
        G.setInterval(Ek, 864E5)) : bk.push(rk)
    }
    var Gk = function(a, b) {
        var c = function() {};
    ...
    var Rk, Sk = Ba.navigator;
    Rk = Sk ? Sk.userAgentData || null : null;
    function Tk(a) {
        return Kk ? Rk ? Rk.brands.some(function(b) {
            var c;
    ...
    var cl = function(a, b, c, d) {
      ...
      , fl = /[?&]($|#)/
      , gl = function(a, b, c) {
        for (var d, e = a.search(dl), f = 0, g, k = []; (g = cl(a, f, b, e)) >= 0; )
    ...
    ;var zl;
    try {
        zl = JSON.parse(kb("eyIwIjoiSU4iLCIxIjoiSU4tVE4iLCIyIjpmYWxzZSwiMyI6Imdvb2dsZS5jby5pbiIsIjQiOiIiLCI1Ijp0cnVlLCI2IjpmYWxzZSwiNyI6ImFkX3N0b3JhZ2V8YW5hbHl0aWNzX3N0b3JhZ2V8YWRfdXNlcl9kYXRhfGFkX3BlcnNvbmFsaXphdGlvbiJ9"))
    } catch (a) {
        O(123),
        yl(2),
        zl = {}
    ...
    var $l = [P.g.R, P.g.U, P.g.P, P.g.ya], am, bm;
    function cm(a) {
    ...
    var tm = Number('') || 500
      ...
      , xm = {}
      , ym = Object.freeze((xm[P.g.Ja] = !0,
    xm))
      , zm = H.location.search.indexOf("?gtm_diagnostics=") >= 0 || H.location.search.indexOf("&gtm_diagnostics=") >= 0
      , Am = void 0;
    function Bm(a, b) {
        if (b.length && wj) {
            var c;
            ...
            !Am && d.length > 0 && (T(43) ? yk("tdc", !0) : Fc(G, "pagehide", Cm),
    ...
    function Dm(a, b, c) {
        if (wj && a === "config") {
            var d, e = (d = om(b)) == null ? void 0 : d.ma;
            if (!(e && e.length > 1)) {
                ...
                for (n in f)
                    if (f.hasOwnProperty(n)) {
                        var p = Em(f[n], k);
                        p.length && (zm && console.log(p),
                        m.push(n))
                    }
                m.length && (Bm(b, m),
                mb("TAGGING", wm[H.readyState] || 14));
                f[b] = k
            }
        }
    }
    ...
    function Cm() {
        Object.keys(um).length !== 0 && (G.clearTimeout(Am),
        nk())
    }
    function Hm() {
        var a = [], b;
        for (b in um)
            um.hasOwnProperty(b) && a.push(b + "*" + um[b].join("."));
        return a.length ? a.join("!") : void 0
    }
    function Im() {
        T(43) ? xk("tdc", function() {
            Am && (G.clearTimeout(Am),
            Am = void 0);
            return Hm()
        }, !1) : bk.push(Gm)
    }
    ;var Jm = function(a, b, c, d, e, f, g, k, m, n, p) {
      ...
      , W = function(a, b, c, d) {
        for (var e = na(Km(a, d === void 0 ? 3 : d)), f = e.next(); !f.done; f = e.next()) {
            var g = f.value;
            if (g[b] !== void 0)
                return g[b]
        }
      ...
      , Lm = function(a) {
        for (var b = {}, c = Km(a, 4), d = na(c), e = d.next(); !e.done; e = d.next())
      ...
      , Nm = function(a) {
        for (var b = [P.g.Sc, P.g.Oc, P.g.Pc, P.g.Qc, P.g.Rc, P.g.Tc, P.g.Uc], c = Km(a, 3), d = na(c), e = d.next(); !e.done; e = d.next()) {
      ...
      , Zm = function(a) {
        return new Jm(a.eventId,a.priorityId,a.D,a.O,a.j,a.H,a.K,a.eventMetadata,a.onSuccess,a.onFailure,a.isGtmEvent)
    };
    var $m = {};
    function an(a, b, c) {
        vj && a !== void 0 && ($m[a] = $m[a] || [],
        ...
        if (d.j) {
            ...
            if (f) {
                ...
                var r = d.j.prefix
                  ...
                  , u = Zm(Ym(Xm(Wm(Vm(Tm(Sm(Um(Rm(Qm(Pm(new Om(d.messageContext.eventId,d.messageContext.priorityId), g), k), m), n), p), q), d.messageContext.eventMetadata), function() {
                    if (t) {
                        var v = t;
                        t = void 0;
                        v("2");
    ...
    mn.prototype.push = function(a, b, c, d) {
        c !== void 0 && (hn(this, c).status === 1 && (hn(this, c).status = 2,
        this.push("require", [{}], c, {})),
    ...
    mn.prototype.flush = function(a) {
        for (var b = this, c = [], d = !1, e = {}; this.j.length; e = {
            ...
            if (f.messageContext.deferrable)
                !g || hn(this, g).H ? (f.messageContext.deferrable = !1,
    ...
    var rn = function(a) {
      ...
      , qn = function(a, b) {
        ...
        if (c.fetch) {
            ...
            pn(c, a, b === void 0 ? !1 : b, d === void 0 ? !1 : d)
    };
    var sn = function() {
        this.O = this.O;
        this.D = this.D
    ...
    un.prototype.Pa = function() {
        this.Z = {};
        this.K && (Jk(this.H, "message", this.K),
        delete this.K);
        delete this.Z;
        delete this.H;
        delete this.j;
    ...
    var zn = function(a, b, c) {
        ...
        if (k === 0)
            ...
            m = k === 1 ? a.purpose && a.vendor ? yn(a.purpose.legitimateInterests, b) && yn(a.vendor.legitimateInterests, d === void 0 ? "755" : d) : !0 : !0;
        return m
    }
      , yn = function(a, b) {
        return !(!a || !a[b])
                ...
                b.addEventListener(function(c) {
                    ...
                    !In(c) || Fn() || Gn()) {
                            ...
                            for (k in Cn)
                                if (Cn.hasOwnProperty(k))
                                    if (k === "1") {
                                        ...
                                        p = p === void 0 ? {} : p;
                                        m = Bn(n) ? n.gdprApplies === !1 ? !0 : n.tcString === "tcunavailable" ? !p.Gj : (p.Gj || n.gdprApplies !== void 0 || p.zl) && (p.Gj || typeof n.tcString === "string" && n.tcString.length) ? zn(n, "1", 0) : !0 : !1;
                                        g["1"] = m
                                    } else
                                        g[k] = zn(c, k, Cn[k]);
                            d = g
                        ...
                        if (d) {
                            ...
                            q);
                            a.gdprApplies !== !0 ? (km([P.g.R, P.g.ya, P.g.P]),
                            Il().active = !0) : (r[P.g.ya] = a.kc["3"] && a.kc["4"] ? "granted" : "denied",
                            typeof a.tcfPolicyVersion === "number" && a.tcfPolicyVersion >= 4 ? r[P.g.P] = a.kc["1"] && a.kc["7"] ? "granted" : "denied" : km([P.g.P]),
                            em(r, {
                                eventId: 0
                            }, {
    ...
    var Tn = function(a) {
      ...
      , Vn = function() {
        var a = {}, b;
        for (b in Qn)
            Qn.hasOwnProperty(b) && (a[Qn[b]] = Sl(b));
    ...
    var Zn = function(a) {
        for (var b = "1", c = 0; c < Nn.length; c++) {
            var d = b, e, f = Nn[c], g = Ql.delegatedConsentTypes[f];
      ...
      , $n = function() {
        if (!Rl(P.g.P))
            return "-";
        for (var a = Object.keys(gi), b = Tl(a), c = "", d = na(a), e = d.next(); !e.done; e = d.next()) {
            var f = e.value;
            b[f] && (c += gi[f])
        }
        T(50) && (Ql.usedCorePlatformServices ? Ql.selectedAllCorePlatformServices : 1) && (c += "o");
        return c || "-"
    }
      , ao = function() {
    ...
    function ho(a) {
        ...
        Ai.H ? (c.Hf = 0,
        c.Zk = 2) : pi ? c.Hf = 1 : fo() ? c.Hf = 2 : c.Hf = 3;
        var e = {};
        e[6] = Bj;
        c.fl = e;
        var f = a.Af, g;
        ...
        var L = c.fl;
        L = L === void 0 ? {} : L;
        for (var R = [], V = na(Object.keys(L)), ba = V.next(); !ba.done; ba = V.next()) {
            var aa = ba.value;
            R[Number(aa)] = L[aa]
        }
        if (R.length) {
    ...
    function Bo(a, b) {
        return a !== void 0 && (Eo.test(window.document.location.hostname) || b === "/" && Do.test(a))
    }
    function Fo(a) {
        if (!a)
            return 1;
    ...
    var to = function() {
      ...
      , so = function(a) {
        return a && Nl().j() ? (Array.isArray(a) ? a : [a]).every(function(b) {
            return Ul(b) && Rl(b)
        }) : !0
    }
      , Ao = function() {
    ...
    function ep(a, b) {
        function c(n, p, q) {
            ...
            if (r) {
                ...
                var y = v.join("*");
                u = ["1", Zo(y), y].join("*");
                d ? (Ti(3) || Ti(1) || !p) && fp("_gl", u, a, p, q) : gp("_gl", u, a, p, q)
            }
        }
    ...
    ;var Jp = new Map([[5, "ad_storage"], [4, ["ad_storage", "ad_user_data"]]]);
    function Kp(a) {
        if (Gp[5]) {
            for (var b = [], c = ro(a, void 0, void 0, Jp.get(5)), d = na(c), e = d.next(); !e.done; e = d.next()) {
                var f = Hp(e.value);
                f && (Lp(f),
                b.push(f))
            }
    ...
    function Lp(a) {
        ...
        c = b.next()) {
            ...
            }(d)) : void 0 : typeof f === "string" && Np(f, d.te) || (a[e] = void 0) : a[e] = void 0
        }
    }
    ;var Op = /^\w+$/
      , Pp = /^[\w-]+$/
    ...
    function aq(a) {
        for (var b = Kp(a) || [], c = [], d = na(b), e = d.next(); !e.done; e = d.next()) {
            var f = e.value
              , g = f
              , k = dq(f);
            k && bq(c, "2", g.k, k, g.b || [])
    ...
    function Wp(a) {
        for (var b = [], c = ro(a, H.cookie, void 0, Sp()), d = na(c), e = d.next(); !e.done; e = d.next()) {
            var f = eq(e.value);
            if (f != null) {
                var g = f;
    ...
    function hq(a, b, c, d, e, f) {
        ...
        c && k(c, "dc");
        d !== void 0 && Pp.test(d) && (g.wbraid = d,
        k(d, "gb"));
        Ti(6) && e !== void 0 && Pp.test(e) && (g.gbraid = e,
        k(e, "ag"));
        f !== void 0 && Pp.test(f) && (g.gad_source = f,
        k(f, "gs"));
        return g
    }
    function jq(a) {
          ...
          , q = function() {
            if (Tp(m)) {
                ...
                if (!n && a.gb) {
                    var y = a.gb[0]
                      , B = $p("gb", f);
                    !b && Wp(B).some(function(F) {
                        return F.aa === y && F.labels && F.labels.length > 0
                    }) || t("gb", u(y))
                }
            }
            if (!p && Ti(6) && a.gbraid && Tp("ad_storage") && (p = !0,
            !n)) {
                var A = a.gbraid
                  , D = $p("ag", f);
                if (b || !(Ti(6) ? aq(D) : []).some(function(F) {
            ...
            for (var d = Zp(b.prefix), e = 0; e < a.length; ++e) {
                ...
                if (Rp[f] !== void 0) {
                    var g = $p(f, d)
                      , k = c[g];
                    if (k) {
                        var m = Math.min(nq(k), Db()), n;
                        b: {
                            for (var p = m, q = ro(g, H.cookie, void 0, Sp()), r = 0; r < q.length; ++r)
                                if (nq(q[r]) > p) {
                                    n = !0;
                                    break b
                                }
    ...
    function nq(a) {
        return pq(a.split(".")).length !== 0 ? (Number(a.split(".")[1]) || 0) * 1E3 : 0
    }
    function dq(a) {
    ...
    function pq(a) {
        return a.length < 3 || a[0] !== "GCL" && a[0] !== "1" || !/^\d+$/.test(a[1]) || !Pp.test(a[2]) ? [] : a
    }
        ...
        if (qo(G)) {
            ...
            Up(function() {
                z(d, function(f, g) {
                    ...
                    if (k.length) {
                        var m = k[0], n = nq(m), p = pq(m.split(".")).length !== 0 ? m.split(".").slice(3) : [], q = {}, r;
    ...
    ;var br = RegExp("^UA-\\d+-\\d+%3A[\\w-]+(?:%2C[\\w-]+)*(?:%3BUA-\\d+-\\d+%3A[\\w-]+(?:%2C[\\w-]+)*)*$")
      , cr = /^~?[\w-]+(?:\.~?[\w-]+)*$/
    ...
    function gr(a, b) {
        if (dr.test(H.location.host)) {
            ...
            return c && c.length === 2 && c[1].match(br) ? decodeURIComponent(c[1]) : ""
        }
    ...
    function hr(a, b, c) {
        for (var d = Tp(Sp()) ? Ap("_gac_gb", !0) : {}, e = [], f = !1, g = na(Object.keys(d)), k = g.next(); !k.done; k = g.next()) {
            var m = k.value
    ...
    function jr(a) {
        ...
        dr.test(H.location.host) && (c = ir("gclgs"),
        d = ir("gclst"));
        if (c && d)
            b.hh = c,
            b.ih = d;
    ...
    function kr(a, b, c) {
        if (dr.test(H.location.host)) {
            ...
            if (b === "gclid")
                return Wp((a || "_gcl") + "_aw");
            if (b === "wbraid")
                return Wp((a || "_gcl") + "_gb");
            if (b === "braids")
                return Yp({
                    prefix: a
                })
    ...
    function lr(a) {
        return kr(a, "gclid", "gclaw").map(function(b) {
            return b.aa
        }).join(".")
    }
    function mr(a) {
        return kr(a, "wbraid", "gclgb").map(function(b) {
            return b.aa
        }).join(".")
    }
    function nr(a) {
        return kr(a, "braids", "gclgb").map(function(b) {
            return b.aa
        }).join(".")
    }
    function or(a, b) {
    ...
    ;var Jr = function(a, b) {
      ...
      , Pr = {
        ...
        Kh: "www.gstatic.com/call-tracking/call-tracking_" + (Or.jk || Or.Qk) + ".js"
    }
      , Qr = {}
      ...
      , Sr = function(a, b, c, d, e) {
        ...
        if (b && c) {
            ...
            for (var f = {
                ...
                var k = a[g];
                Qr[k.id] || (k && k.prefix === "AW" && !f.adData && k.ma.length >= 2 ? (f.adData = {
                    ak: k.ma[rm[1]],
                    cl: k.ma[rm[2]]
                },
                Jr(f.adData, d),
                Qr[k.id] = !0) : k && k.prefix === "UA" && !f.gaData && (f.gaData = {
                    gaWpid: k.ia
                },
                Qr[k.id] = !0))
            }
      ...
      , Ur = function(a, b) {
        if (a)
            if (fo()) {} else if (a = l(a) ? om(Oj(a)) : om(Oj(a.id))) {
                var c = void 0
                  , d = !1
                  , e = W(b, P.g.Ni);
    ...
    var lt = "https://" + hi.Ed + "/gtm/static/", mt;
    function rt(a, b) {}
    function st(a, b, c, d) {}
    function tt(a, b, c, d) {}
    function ut(a, b, c, d) {}
    ...
    Yk();
    !Uk("Safari") || Yk() || (Vk() ? 0 : Uk("Coast")) || Wk() || (Vk() ? 0 : Uk("Edge")) || (Vk() ? Tk("Microsoft Edge") : Uk("Edg/")) || (Vk() ? Tk("Opera") : Uk("OPR")) || Xk() || Uk("Silk") || Uk("Android") || al();
    var zt = {}
      , At = null
      , Bt = function(a) {
        for (var b = [], c = 0, d = 0; d < a.length; d++) {
        ...
        for (var r = zt[f], t = Array(Math.floor(b.length / 3)), u = r[64] || "", v = 0, w = 0; v < b.length - 2; v += 3) {
            var x = b[v]
              , y = b[v + 1]
              , B = b[v + 2]
              , A = r[x >> 2]
    ...
    Object.freeze(new Ct);
    var Dt = "platform platformVersion architecture model uaFullVersion bitness fullVersionList wow64".split(" ");
    function Et(a) {
        var b;
    ...
    function It() {
        ...
        var c = a.navigator.userAgentData.getHighEntropyValues(Dt).then(function(d) {
    ...
    ;var Pt = !1;
    function Qt() {
        if (Ot("join-ad-interest-group") && qb(rc.joinAdInterestGroup))
            return !0;
        Pt || (jl(''),
        Pt = !0);
    ...
    ;var Iv = function(a, b, c) {
        ...
        if (b) {
            ...
            if (!e)
                return !1;
            var g = Bt(decodeURIComponent(f.replace(/\+/g, " ")) + ":" + decodeURIComponent(e.replace(/\+/g, " ")));
            if (!Hv(g, b))
                return !1
        }
        d && d != 4 && (a = gl(a, "rfmt", d));
    ...
    function kw() {
        ...
        gw.test(G.location && G.location.hostname) && (ni ? O(116) : (O(117),
        lw && (a = [],
        ...
        c ? O(8) : c = [];
        gw.test(G.location && G.location.hostname) && (c = Ab(c),
        ...
        return function(f) {
            ...
            var u = !m || q;
            u || !(k.indexOf("sandboxedScripts") >= 0) || b && b.indexOf("sandboxedScripts") !== -1 || (u = vb(d, jw));
            return e[g] = u
        }
    }
    var lw = !1;
        ...
        if (!nw()) {
            ...
            if (!Tj(f)) {
                ...
                if (!p) {
                    ...
                    p = Ir("https://", "http://", q + g)) : p = Ai.D ? Bi() + n + g : Ir("https://", "http://", q + g)
                }
                d.siloed && Vj({
                    ctid: f,
                    isDestination: !1
    ...
    ;var Vw = {}
      ...
      , Xw = {};
    function Yw(a, b, c, d) {
        vj && T(74) && ((d === void 0 ? 0 : d) ? (Xw[b] = Xw[b] || 0,
        ++Xw[b]) : c !== void 0 ? (Ww[a] = Ww[a] || {},
        Ww[a][b] = Math.round(c)) : (Vw[a] = Vw[a] || {},
        Vw[a][b] = (Vw[a][b] || 0) + 1))
    }
    function Zw(a) {
        var b = a.eventId, c = a.Sa, d = Vw[b] || {}, e = [], f;
        for (f in d)
    ...
    function $w(a) {
        var b = a.eventId, c = a.Sa, d = Ww[b] || {}, e = [], f;
        for (f in d)
            d.hasOwnProperty(f) && e.push("" + f + d[f]);
        c && delete Ww[b];
    ...
    function ax() {
        for (var a = [], b = na(Object.keys(Xw)), c = b.next(); !c.done; c = b.next()) {
            var d = c.value;
            a.push("" + d + Xw[d])
        }
    ...
    function ux(a) {
        for (var b = [], c = 0; c < a.length; c++)
            if (a[c]) {
                ...
                if (ji[d] || hf[c][Ie.Ok] !== void 0 || $v(d, 2))
                    b[c] = !0
            }
        return b
    }
    ...
    var Yx = [P.g.jd, P.g.Lb, P.g.yc, P.g.lb, P.g.tb, P.g.Ba, P.g.sa, P.g.Na, P.g.Va, P.g.Eb]
      , Zx = {
        config: function(a, b) {
            var c = Tx(a, b);
            if (!(a.length < 2) && l(a[1])) {
                ...
                if (e) {
                    ...
                    if (t ? Fj().indexOf(r) === -1 : Cj().indexOf(r) === -1) {
                        ...
                        wj && !Bj && (xx === 1 && (T(43) ? vk.mcc = !1 : Gc(G, "pagehide", yx)),
                        xx = 2);
                        if (mi && !t && !d[P.g.Zb]) {
                            var D = Sx;
                            Sx = !0;
        ...
        consent: function(a, b) {
            if (a.length === 3) {
                ...
                e[P.g.ya] && O(140));
                d === "default" ? dm(e) : d === "update" ? em(e, c) : d === "declare" && b.fromContainerExecution && cm(e)
            }
        },
        event: function(a, b) {
            var c = a[1];
            if (!(a.length < 2) && l(c)) {
                ...
                if (A) {
                    var D;
                    !A.length || ((D = b.eventMetadata) == null ? 0 : D.em_event) || (Qx = !0);
                    Tw(m, c);
                    for (var E = [], C = 0; C < A.length; C++) {
                        ...
                        if (Ox.indexOf(Oj(F.prefix)) !== -1) {
                            var L = h(d)
                              , R = M.eventMetadata || {};
                            R.hasOwnProperty("is_external_event") || (R.is_external_event = !M.fromContainerExecution);
                            M.eventMetadata = R;
                            delete L[P.g.bd];
                            en(c, L, F.id, M);
                            wj && !Bj && xx === 0 && (T(43) ? xk("mcc", "1") : Fc(G, "pagehide", yx),
                            xx = 1)
                        }
                        E.push(F.id)
                    }
    ...
    ;function sz() {
        var a = [["cv", T(82) ? rz() : "3"], ["rv", hi.Kg], ["tc", hf.filter(function(b) {
            return b
        }).length]];
    ...
    function kB(a) {
        ...
        }, this.F, Ib(Hz(this).wb(), "__cvt_") ? 2 : 1)
    }
    kB.T = "createQueue";
    function lB(a, b) {
        var c = null;
    ...
    var sB = function(a) {
      ...
      , tB = function(a, b, c) {
        ...
        if (d) {
            ...
            var p = Kz(a, "selectorToTriggerIds", {}), q;
            for (q in p)
    ...
    function uB(a, b) {
        ...
        if (e || d) {
            if (d && Oz(g, "commonButtonIds", k, []),
            e) {
                var m = Bb(String(c.cssSelector));
                Oz(g, "selectorToTriggerIds", function(n) {
    ...
    var jc = ka(["data-gtm-yt-inspected-"]), CC = ["www.youtube.com", "www.youtube-nocookie.com"], DC, EC = !1;
    function OC(a, b) {
        var c = this;
        return b
    }
    ...
    var DD = function(a, b) {
      ...
      , ID = function(a, b, c) {
        if (!c.isGtmEvent || !FD[a]) {
            var d = !X(P.g.U)
              , e = function(f) {
                var g, k, m = Hw(), n = GD(b, "", c), p, q = n.createOnlyFields._useUp;
      ...
      , SD = function(a, b, c) {
        function d() {
            ...
            k(function() {
                if (!c.isGtmEvent && Xa(L)) {
                    var R = u.fieldsToSend, V = m().getByName(n), ba;
                    for (ba in L)
        ...
        var f = a, g, k = c.isGtmEvent ? Iw(W(c, "gaFunctionName")) : Iw();
        if (qb(k)) {
            var m = Hw, n;
            ...
            var p = function(L) {
              ...
              , q = function(L) {
                ...
                if (ba) {
                    ...
                    Q !== "promo_view" && Q !== "impressions" && (R("ec:addProduct", ba.Kc),
                    p("ec:setAction", Q, ba.ub))
                }
            }
              , r = function(L) {
                if (L) {
                    ...
                    if (Xa(L))
                        for (var V in ND)
                            ND.hasOwnProperty(V) && OD(ND[V], V, L[V], R);
                    JD(R, y);
                    p("require", "linkid", R)
                }
            }
            ...
            !c.isGtmEvent && HD(n, u.createOnlyFields) && (k(function() {
                m() && m().remove(n)
            }),
            PD[n] = !1);
            ...
            if (!c.isGtmEvent && u.createOnlyFields[P.g.pb] || w) {
                var x = lj() ? kj(c.isGtmEvent ? u.fieldsToSet[P.g.pb] : u.createOnlyFields[P.g.pb], "/analytics.js") : void 0;
                x && (g = x)
            }
            var y = c.isGtmEvent ? u.fieldsToSet[P.g.pb] : u.createOnlyFields[P.g.pb];
            if (y) {
                var B = c.isGtmEvent ? u.fieldsToSet[P.g.Ud] : u.createOnlyFields[P.g.Ud];
                B && !PD[n] && (PD[n] = !0,
                k(Lw(n, B)))
            }
            ...
            if (b === P.g.Sb)
                ...
                ID(f, n, c)) : b === P.g.Ta ? DD(n, c) : b === "screen_view" ? p("send", "screenview", u.fieldsToSend) : b === "timing_complete" ? (u.fieldsToSend.hitType = "timing",
    ...
    nE)), pE = function(a) {
        var b = "general";
        mE[a] ? b = "ecommerce" : oE[a] ? b = "engagement" : a === "exception" && (b = "error");
        return b
    ...
    qE)), KD = function(a, b, c) {
        ...
        for (var r = !c.isGtmEvent, t = Lm(c), u = 0; u < t.length; ++u) {
            ...
            if (c.isGtmEvent) {
                var w = d(v);
                gE.hasOwnProperty(v) ? e[v] = w : bE.hasOwnProperty(v) ? k[v] = w : g[v] = w
            } else {
                var x = void 0;
                ...
                if (fE.hasOwnProperty(v))
                    ...
                    var B = void 0
                      , A = void 0;
                    b === P.g.ba ? B = Nb(Mm(c, v), ".") : (B = Nb(Mm(c, v, 1), "."),
                    A = Nb(Mm(c, v, 2), "."));
                    B && (f["&gdid"] = B);
                    A && (f["&edid"] = A)
                } else
                    v === P.g.Na && t.indexOf(P.g.uc) < 0 && (k.cookieName = x + "_ga");
                T(90) && ZD[v] && (c.H.hasOwnProperty(v) || b === P.g.ba && c.j.hasOwnProperty(v)) && (r = !1)
            }
        }
        T(90) && r && (f["&jsscut"] = "1");
        d(P.g.Te) !== !1 && d(P.g.kb) !== !1 && zD() || (g.allowAdFeatures = !1);
        ...
        if (c.isGtmEvent) {
            ...
            b === "login" || b === "sign_up" || b === "share" ? KD(e, "eventLabel", d(P.g.rg)) : b === "search" || b === "view_search_results" ? KD(e, "eventLabel", d(P.g.Pi)) : b === "select_content" && KD(e, "eventLabel", d(P.g.vi));
            var E = e[P.g.sa] || {}
              , C = E[P.g.Cc];
            C || C != 0 && E[P.g.W] ? k.allowLinker = !0 : C === !1 && KD(k, "useAmpClientId", !1);
            f.hitCallback = c.onSuccess;
            k.name = a
        }
        Un() && (g["&gcs"] = Vn());
        g["&gcd"] = Zn(c);
        Vl() && (X(P.g.U) || (k.storage = "none"),
        ...
        if (Xa(k))
            for (var m = 0; e && m < e.length; ++m) {
                var n = e[m], p;
                for (p in k)
                    k.hasOwnProperty(p) && /^(dimension|metric)\d+$/.test(p) && k[p] != void 0 && KD(n, p, n[k[p]])
            }
        var q = null
          , r = d(P.g.Ai);
    ...
    ;var zG = window
      ...
      , BG = function(a) {
        ...
        if (b && b.ioo && b.ioo() || AG.documentElement.hasAttribute("data-google-analytics-opt-out") || a && zG["ga-disable-" + a] === !0)
            return !0;
        try {
            var c = zG.external;
        ...
        for (var d = [], e = String(AG.cookie).split(";"), f = 0; f < e.length; f++) {
            var g = e[f].split("=")
              , k = g[0].replace(/^\s*|\s*$/g, "");
            if (k && k == "AMP_TOKEN") {
    ...
    function() {
        ...
        (function(b) {
            ...
            var c;
            c = (c = b.vtp_customUrlSource ? b.vtp_customUrlSource : $I("gtm.url", 1)) || ZI();
    ...
    function() {
        ...
        function b(n) {
            var p = {};
            n.vtp_gaSettings && h(NI(n.vtp_gaSettings.vtp_fieldsToSet, "fieldName", "value"), p);
        ...
        function d(n, p, q) {}
        function e(n, p) {
            if (!f && (!lj() || !p._x_19 || n.vtp_useDebugVersion || n.vtp_useInternalVersion)) {
                ...
                var r = n.vtp_gtmOnFailure
                  ...
                  , u = Ir("https:", "http:", "//www.google-analytics.com/" + q, p && !!p.forceSSL);
                YI(q === "analytics.js" && t ? t : u, function() {
                    var v = Hw();
                    v && v.loaded || r();
                }, r)
            }
        ...
        var f, g = {
            ...
            var w = b(n)
              ...
              , B = ""
              , A = "";
            n.vtp_setTrackerName && typeof n.vtp_trackerName == "string" ? n.vtp_trackerName !== "" && (A = n.vtp_trackerName,
            B = A + ".") : (A = "gtm" + yi(),
            B = A + ".");
            var D = function(ma, ia) {
                for (var za in ia)
                    ia.hasOwnProperty(za) && (w[ma + za] = ia[za])
            };
            D("contentGroup", q);
            D("dimension", r);
            D("metric", t);
            ...
            var F = Zm(Ym(Xm(Wm(Pm(new Om(n.vtp_gtmEventId,n.vtp_gtmPriorityId), C), n.vtp_gtmOnSuccess), n.vtp_gtmOnFailure), !0));
    ...
    (function(a) {
        ...
        var g = function(u) {
            ...
            Bc("https://" + hi.Ed + "/debug/bootstrap?id=" + Mf.ctid + "&src=" + w + "&cond=" + u + "&gtm=" + ho()));
            var y = {
        ...
        try {
            ...
            if (yj().canonical[a]) {
                ...
                fJ();
                if (!ri)
                    for (var V = Dl() ? Ci(Ai.O) : Ci(Ai.Z), ba = 0; ba < $l.length; ba++) {
                        var aa = $l[ba]
                          , Q = aa
                ...
                if (wj) {
                    ...
                    if (T(43)) {
                        ...
                        bk.push(Ey);
                    T(28) && (T(43) ? xk("bt", String(Ai.H ? 2 : pi ? 1 : 0)) : bk.push(By))
                }
                fz();
                yl(1);
                HA();
