    ...
    return function(a, b, c, d) {
            ...
            if (a)
                for (var b = (new Date).getTime(), c = 0, e = t.State.calls.length; e > c; c++)
                    if (t.State.calls[c]) {
                            ...
                            if (g(u)) {
                                ...
                                for (var z in s)
                                    if ("element" !== z) {
                                        ...
                                        if (1 === o)
                                            A = B.endValue;
                                        else if (A = B.startValue + (B.endValue - B.startValue) * C(o),
                                        !n && A === B.currentValue)
                                            continue;
                                        if (B.currentValue = A,
                        ...
                        i.display !== d && "none" !== i.display && (t.State.calls[c][2].display = !1),
                        i.visibility !== d && "hidden" !== i.visibility && (t.State.calls[c][2].visibility = !1),
        ...
        function l(a, b) {
            ...
            for (var c = t.State.calls[a][0], e = t.State.calls[a][1], f = t.State.calls[a][2], h = t.State.calls[a][4], i = !1, j = 0, k = c.length; k > j; j++) {
                ...
                h && f.loop !== !0 && h(e),
                f.loop !== !0 || b || (m.each(g(l).tweensContainer, function(a, b) {
            ...
            getPropertyValue: function(a, c, e, f) {
                function h(a, c) {
                    ...
                    if (8 >= n)
                        ...
                        (n || t.State.isFirefox) && "borderColor" === c && (c = "borderTopColor"),
        ...
        var w = function() {
            ...
            function h() {
                function a() {
                    function a(a, b) {
                        ...
                        !p.isArray(a[1]) && /^[\d-]/.test(a[1]) || p.isFunction(a[1]) || v.RegEx.isHex.test(a[1]) ? f = a[1] : (p.isString(a[1]) && !v.RegEx.isHex.test(a[1]) || p.isArray(a[1])) && (e = b ? a[1] : j(a[1], i.duration),
                        a[2] !== d && (f = a[2]))) : c = a,
                        b || (e = e || i.easing),
                    ...
                    function o() {
                        ...
                        if (e && d)
                            ...
                            i.percentToPxWidth = J.lastPercentToPxWidth = (parseFloat(v.getPropertyValue(j, "width", null, !0)) || 1) / f,
                        ...
                        null === J.vwToPx && (J.vwToPx = parseFloat(b.innerWidth) / 100,
                        J.vhToPx = parseFloat(b.innerHeight) / 100),
                        i.remToPx = J.remToPx,
                        i.vwToPx = J.vwToPx,
                        i.vhToPx = J.vhToPx,
                        t.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(i), h),
                        i
                    }
                    if (i.begin && 0 === z)
                        try {
                    ...
                    if ("scroll" === D) {
                        ...
                        A = w + m(h).position()[B.toLowerCase()] + E) : i.container = null : (w = t.State.scrollAnchor[t.State["scrollProperty" + B]],
                        ...
                        if (!g(h).tweensContainer)
                            return void m.dequeue(h, i.queue);
                        "none" === g(h).opts.display && (g(h).opts.display = "auto"),
                        "hidden" === g(h).opts.visibility && (g(h).opts.visibility = "visible"),
                        g(h).opts.loop = !1,
                        g(h).opts.begin = null,
                        ...
                        var F;
                        g(h).tweensContainer && g(h).isAnimating === !0 && (F = g(h).tweensContainer),
                        ...
                        for (var I in s) {
                            ...
                            if (g(h).isSVG || v.Names.prefixCheck(P)[1] !== !1 || v.Normalizations.registered[P] !== d) {
                                ...
                                i._cacheValues && F && F[I] ? (O === d && (O = F[I].endValue + F[I].unitType),
                                Q = g(h).rootPropertyValueCache[P]) : v.Hooks.registered[I] ? O === d ? (Q = v.getPropertyValue(h, P),
                                ...
                                O = parseFloat(O) || 0,
                                M = parseFloat(M) || 0,
                                "%" === S && (/^(fontSize|lineHeight)$/.test(I) ? (M /= 100,
                                S = "em") : /^scale/.test(I) ? (M /= 100,
                                S = "") : /(Red|Green|Blue)$/i.test(I) && (M = M / 100 * 255,
                                S = "")),
                                /[\/*]/.test(U))
                                    S = T;
                                else if (T !== S && 0 !== O)
                    ...
                    l.element && (v.Values.addClass(h, "velocity-animating"),
                    K.push(l),
                    "" === i.queue && (g(h).tweensContainer = l,
                    g(h).opts = i),
                    g(h).isAnimating = !0,
                    z === y - 1 ? (t.State.calls.length > 1e4 && (t.State.calls = e(t.State.calls)),
                    t.State.calls.push([K, q, i, null, C.resolver]),
                    t.State.isTicking === !1 && (t.State.isTicking = !0,
                    k())) : z++)
                }
                var f, h = this, i = m.extend({}, t.defaults, u), l = {};
                switch (g(h) === d && t.init(h),
                parseFloat(i.delay) && i.queue !== !1 && m.queue(h, i.queue, function(a) {
                ...
                "auto" === i.display && (i.display = t.CSS.Values.getDisplayType(h))),
                ...
                i.queue === !1 ? i.delay ? setTimeout(a, i.delay) : a() : m.queue(h, i.queue, function(b, c) {
                    return c === !0 ? (C.promise && C.resolver(q),
            ...
            q = f(q)) {
                x ? (s = arguments[0].properties,
                u = arguments[0].options) : (s = arguments[o],
                u = arguments[o + 1]);
                var y = q.length
                  , z = 0;
                    ...
                    return m.each(t.State.calls, function(a, b) {
                        b && m.each(b[1], function(c, e) {
                            ...
                            return u !== d && b[2].queue !== f ? !0 : void m.each(q, function(b, c) {
                                ...
                                m.queue(c, f, [])),
                                g(c) && "" === f && m.each(g(c).tweensContainer, function(a, b) {
                    ...
                    if (!m.isPlainObject(s) || p.isEmptyObject(s)) {
                        if (p.isString(s) && t.Redirects[s]) {
                            var F = m.extend({}, u)
                              , G = F.duration
                              , H = F.delay || 0;
                            return F.backwards === !0 && (q = m.extend(!0, [], q).reverse()),
                            m.each(q, function(a, b) {
                        ...
                        return C.promise ? C.rejecter(new Error(I)) : console.log(I),
                        a()
                    }
                    D = "start"
                }
    ...
    j(O, y, {
        handler: function(a) {
            ...
            this.started) {
                ...
                b & (Ab | Bb) && 0 === c[0].length - c[1].length && (this.started = !1),
                this.callback(this.manager, b, {
                    pointers: c[0],
                    changedPointers: c[1],
                    pointerType: tb,
    ...
    a.fn.collapsible = function(b) {
        ...
        this.each(function() {
            function c(a) {
                ...
                a.parent().hasClass("active") ? a.siblings(".collapsible-body").stop(!0, !1).slideDown({
                    duration: 350,
                    easing: "easeOutQuart",
                    queue: !1
                ...
                f.not(a).parent().children(".collapsible-body").stop(!0, !1).slideUp({
                    duration: 350,
                    easing: "easeOutQuart",
                    queue: !1
                })
            ...
            e.off("click.collapse", ".collapsible-header"),
            f.off("click.collapse"),
            b.accordion || "accordion" == g || void 0 == g ? (e.on("click.collapse", ".collapsible-header", function(b) {
                c(a(b.currentTarget))
            }),
...
function(a) {
    ...
    a.fn.dropdown = function(b) {
        ...
        this.each(function() {
            function c() {
                void 0 != g.data("inDuration") && (b.inDuration = g.data("inDuration")),
                void 0 != g.data("outDuration") && (b.outDuration = g.data("outDuration")),
                void 0 != g.data("constrainwidth") && (b.constrain_width = g.data("constrainwidth")),
                void 0 != g.data("hover") && (b.hover = g.data("hover")),
                void 0 != g.data("alignment") && (b.alignment = g.data("alignment")),
                void 0 != g.data("gutter") && (b.gutter = g.data("gutter")),
                void 0 != g.data("beloworigin") && (b.belowOrigin = g.data("beloworigin"))
            }
            function d() {
                c(),
                1 == b.constrain_width && h.css("width", g.outerWidth());
                var d = 0;
                1 == b.belowOrigin && (d = g.height());
                var f = 0
                  , j = b.gutter;
                "right" == b.alignment && (f = g.innerWidth() - h.innerWidth(),
                j = -1 * j),
                h.css(e(g[0]) ? {
                    display: "block",
                    position: "fixed",
            ...
            function e(b) {
                ...
                return d.each(function() {
                    return "fixed" === a(this).css("position") ? (e = !0,
                    !1) : void 0
                }),
                e
            }
            ...
            if (b.hover)
                ...
                g.bind("click." + g.attr("id"), function(b) {
                    g[0] == b.currentTarget && (b.preventDefault(),
                    d()),
                    a(document).bind("click." + h.attr("id"), function(b) {
                        !h.is(b.target) && !g.is(b.target) && !g.find(b.target).length > 0 && (f(),
                        a(document).unbind("click." + h.attr("id")))
                    })
                })
            }
            g.on("open", d),
...
function(a) {
    a.fn.extend({
        openModal: function(b) {
            ...
            b = a.extend(e, b),
            b.dismissible && (a("#lean-overlay").click(function() {
                a(c).closeModal(b)
            }),
        ...
        return this.each(function() {
            function c(c) {
                ...
                var f = d.children("img").height()
                  ...
                  , m = (l - i) / (e + k)
                  , n = -1 * g * m;
                h > j && j + k > i && d.children("img").first().css("bottom", n + "px"),
    ...
    var b = {
        init: function(b) {
            ...
            a(this).each(function() {
                ...
                e.hasClass("fixed") || e.css("left", -1 * (b.menuWidth + 10))),
                ...
                a(".drag-target").hammer({
                    ...
                    if ("touch" === d.gesture.pointerType) {
                        ...
                        "left" === b.edge ? (f < b.menuWidth / 2 ? g = !1 : f >= b.menuWidth / 2 && (g = !0),
                        e.css("left", f - b.menuWidth)) : (f < a(window).width() - b.menuWidth / 2 ? g = !0 : f >= a(window).width() - b.menuWidth / 2 && (g = !1),
                        e.css("right", -1 * (f - b.menuWidth / 2))),
                        "left" === b.edge) {
                            var i = f / b.menuWidth;
                            a("#sidenav-overlay").velocity({
                                opacity: i
...
function(a) {
    a(document).ready(function() {
        ...
        validate_field = function(a) {
            0 === a.val().length ? a.hasClass("validate") && (a.removeClass("valid"),
            a.removeClass("invalid")) : a.hasClass("validate") && (a.is(":valid") ? (a.removeClass("invalid"),
        ...
        a(e).each(function() {
            a(this).val().length && (d = a(this).val(),
            d = d.replace(/\n/g, "<br>"),
            c.html(d + "<br>"),
        ...
        a.fn.material_select = function(b) {
            a(this).each(function() {
                if ($select = a(this),
                !$select.hasClass("browser-default") && !$select.hasClass("initialized")) {
                    var c = i()
                    ...
                    h.on("focus", function() {
                        a(this).trigger("open"),
                        g = a(this).val(),
                        selectedOption = e.find("li").filter(function() {
                            return a(this).text().toLowerCase() === g.toLowerCase()
                        })[0],
                        activateOption(e, selectedOption)
                    }),
                    h.on("blur", function() {
                    ...
                    onKeyDown = function(b) {
                        ...
                        letter && (filterQuery.push(letter),
                        string = filterQuery.join(""),
                        newOption = e.find("li").filter(function() {
                            return 0 === a(this).text().toLowerCase().indexOf(string)
                        })[0],
                        newOption && activateOption(e, newOption)),
                        13 == b.which && (activeOption = e.find("li.active:not(.disabled)")[0],
                        activeOption && (a(activeOption).trigger("click"),
                        h.trigger("close"))),
                        40 == b.which && (newOption = e.find("li.active").next("li:not(.disabled)")[0],
                        newOption && activateOption(e, newOption)),
                        27 == b.which && h.trigger("close"),
...
function(a) {
    a.fn.slider = function(b) {
        ...
        this.each(function() {
            ...
            if (-1 != i && (e = h.eq(i)),
            400 != b.height && (f.height(b.height + 40),
            g.height(b.height)),
    ...
    a(document).ready(function() {
        ...
        a.fn.pushpin = function(c) {
            ...
            this.each(function() {
                ...
                function e(b, e) {
                    b.each(function() {
                        c.top <= e && c.bottom >= e && !a(this).hasClass("pinned") && (d(a(this)),
                        a(this).css("top", c.offset),
                        a(this).addClass("pinned")),
                        e < c.top && !a(this).hasClass("pin-top") && (d(a(this)),
                        a(this).css("top", 0),
                        a(this).addClass("pin-top")),
                        e > c.bottom && !a(this).hasClass("pin-bottom") && (d(a(this)),
...
function(a) {
    a(document).ready(function() {
        ...
        a(document).on("mouseleave.fixedActionBtn", ".fixed-action-btn", function() {
            var b = a(this);
            b.find("ul a.btn-floating").velocity("stop", !0),
            b.find("ul a.btn-floating").velocity({
                opacity: "0",
                scaleX: ".4",
                scaleY: ".4",
        ...
        a(".dismissable").each(function() {
            a(this).hammer({
                ...
                if ("touch" === b.gesture.pointerType) {
                    ...
                    if (c || d) {
                        var f;
                        f = c ? e.innerWidth() : -1 * e.innerWidth(),
                        e.velocity({
                            translateX: f
                        }, {
                            duration: 100,
...
function(a) {
    ...
    c.prototype.create = function(a, c, d) {
        ...
        c == -1 / 0 || 1 / 0 == c ? e = c : b.isPlainObject(c) && f.isInteger(c.pick) ? c = c.obj : b.isArray(c) ? (c = new Date(c[0],c[1],c[2]),
